...
-- First, let's make sure we have the expired status in the enum
DO $$ 
BEGIN
...
SELECT cron.unschedule('update-expired-bookings');

-- Create an improved function to update expired bookings
...
-- Create a new scheduled job to run every minute
